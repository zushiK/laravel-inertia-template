...
interface Numbers90SortDescendingIconComponentProps {
  className?: string;
}

export const Numbers90SortDescendingIconComponent: React.FC<Numbers90SortDescendingIconComponentProps> = ({ className }) => {
  return (
