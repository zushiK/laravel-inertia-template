...
interface RewindForwardSquare5IconComponentProps {
  className?: string;
}

export const RewindForwardSquare5IconComponent: React.FC<RewindForwardSquare5IconComponentProps> = ({ className }) => {
  return (
