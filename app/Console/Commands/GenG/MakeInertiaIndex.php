 ...
 */
class MakeInertiaIndex extends Command
{
    /**
     ...
     * @var string
     */
    protected $name = 'make:inertia-index';
    ...
    {
        return base_path('/stubs/inertia-index.stub');
    }
    ...
    protected function getPath($name)
    {
        ...
        array_shift($a);
        $model = implode("/", $a);
        return "resources/js/Pages/" . $model . "/Index.tsx";
    }
